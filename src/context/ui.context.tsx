...
const initialState = {
  ...
  isLoginAsDemo:
    typeof window !== "undefined"
      ? localStorage.getItem("isLoginAsDemo")
      : null,
  isLoginAsUser:
  ...
  betWindow: "",
  stacks: [
    100, 500, 1000, 5000, 10000, 20000, 50000, 100000, 250000, 500000, 1000000,
  ],
};
...
export function UIProvider({ children }: { children: React.ReactNode }) {
  ...
  const setLoginData = (data: any) =>
    dispatch({ type: "SET_LOGIN_DATA", data });

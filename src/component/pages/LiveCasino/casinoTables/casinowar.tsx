      ...
      <div className="casino-table-header w-100">
          ...
          <div className="flip-card">
            <div className="flip-card-inner ">
              <div className="flip-card-front">
                <img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/cards/9HH.jpg" />
              </div>
        ...
        <div className="casino-odds-box ">
          <div className="flip-card">
            <div className="flip-card-inner ">
              <div className="flip-card-front">
                <img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/cards/QHH.jpg" />
              </div>
              <div className="flip-card-back">
                <img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/cards/QHH.jpg" />
              </div>
